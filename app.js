...
function myFunction() {
  ...
  if (yourFav == "Monster") {
    ...
    document.writeln('<a href="index.html">' + 'Back To Home' + '</a>')
    ...
    var times = prompt("how many time you wish  to it on my page ")
    document.writeln("you choose " + times + " Image")
    document.writeln('<a class="aFromJS" href="index.html" >' + 'Back To Home' + '</a>')
    for (var i = 0; i < times; i++) {
...
function starsFun(stars) {
  var output = ''
  for (var i = 0; i < stars; i++) {
    output = output + '<img class="imgFromJS" src="star.png" alt="stars">'
  }
  return output;
}
...
function myrate() {
  ...
  document.write('<a class="aFromJS" href="index.html" >' + 'Back To Home' + '</a>')
